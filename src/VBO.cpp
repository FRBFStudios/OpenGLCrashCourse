...
VBO::VBO(GLfloat *vertices, GLsizeiptr size) {
	// VBO memory block is reserved and its ID stored in the variable (declared in the header class)
	glGenBuffers(1, &ID);
	...
	* We can choose between "STATIC", "STREAM" and "DYNAMIC" as well as "DRAW", "READ" and "COPY" to improve performance.
